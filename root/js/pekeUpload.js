    ...
    $.fn.pekeUpload = function(options) {
        ...
        var pekeUpload = {
            ...
            replacehtml: function() {
                ...
                switch (options.dragMode) {
                  case true:
                    switch (options.bootstrap) {
                      ...
                      case false:
                        html = '<div class="pekeupload-drag-area pkuparea pkdragarea" style="cursor:pointer"><h4>' + options.dragText + '</h4><div class="bg"></div></div>';
                        break;
                    }
                    break;
                ...
                this.container = $('<div class="grid row margin"></div>').insertAfter(this.uparea);
            },
            ...
            addRow: function(file) {
                ...
                switch (options.bootstrap) {
                  ...
                  case false:
                    var newRow = $('<div class="pekerow pkrw grid-item" rel="' + i + '"></div>').appendTo(this.container);
                    if (options.showPreview) {
                       // var prev = $('<div class="pekeitem_preview grid-item"></div>').appendTo(newRow);
                        this.previewFile(newRow, file);
                    }
                    ...
                    var dismiss = $('<div class="pkdelfile"></div>').prependTo(newRow);
            ...
            previewFile: function(container, file) {
                ...
                switch (type) {
                  case "image":
                    ...
                    var prev = $('<img height="200" width="200" src="' + fileUrl + '"/>').appendTo(container);
                    break;
